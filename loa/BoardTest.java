...
public class BoardTest {
    ...
    static final Piece[][] TEST_PIECES = {
            { EMP, EMP,  WP,  BP,  BP,  BP,  EMP,  EMP },
            { WP,  EMP, BP, EMP, BP, BP, EMP, EMP  },
    ...
    @Test
    public void regionSizeTests() {
        Board b0 = new Board(BOARD1, BP);
        assertArrayEquals(new Object[]{3, 2, 2, 2, 1, 1, 1},
                b0.getRegionSizes(BP).toArray());
        assertArrayEquals(new Object[]{5, 2, 2, 2, 1},
                b0.getRegionSizes(WP).toArray());

        Board b1 = new Board(BOARD2, BP);
        assertArrayEquals(new Object[]{9},
                b1.getRegionSizes(BP).toArray());
        assertArrayEquals(new Object[]{6, 2, 1},
                b1.getRegionSizes(WP).toArray());

        Board b2 = new Board(TEST_PIECES, BP);
        System.out.println(b2.getRegionSizes(BP));
